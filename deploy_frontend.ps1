...
Write-Host "🚀 Starting Sovereign Terminal Deployment..." -ForegroundColor Cyan
...
if (Test-Path $distPath) {
    ...
    Write-Host "✅ Updated timestamp in $distPath" -ForegroundColor Green
} else {
...
Write-Host "✅ Synced dist/index.html -> index.html (Root Override for Cloudflare)" -ForegroundColor Green
...
Write-Host "🚀 Pushing to GitHub (Triggers Cloudflare Build)..." -ForegroundColor Yellow
git push origin main

Write-Host "✅ Deployment initiated! Wait ~2 mins for Cloudflare Pages." -ForegroundColor Green
Write-Host "🔗 Monitor: https://dash.cloudflare.com/" -ForegroundColor Gray
